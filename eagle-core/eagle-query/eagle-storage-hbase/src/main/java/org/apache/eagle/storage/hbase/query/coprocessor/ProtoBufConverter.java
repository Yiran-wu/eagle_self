...
public final class ProtoBufConverter {
    ...
    public static List<String> fromPBStringList(java.util.List<java.lang.String> groupbyFieldsList) {
        List<String> result = new ArrayList<>();
        if (groupbyFieldsList == null) {
            System.out.println("======wuyiran=== fromPBStringList is null"+ new Exception());
        }
        result.addAll(groupbyFieldsList);

        return result;
    }
//TODO wuyiran  2.5.0 do not support ProtocolStringList
